...
import { ListReportsByUserController } from "@presentation/controller/report/list-reports-by-user.controller";
...
const listReportsByUser = container.resolve(ListReportsByUserController);
